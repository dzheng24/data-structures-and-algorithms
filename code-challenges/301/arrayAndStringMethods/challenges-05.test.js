...
const listFoods = (recipe) => {
  let result = [];
  // Solution code here...
  //source: https://stackoverflow.com/questions/43487975/regex-for-excluding-words-at-start-of-string
  let regex = /^(\S+\s){2}/gi;
  let ingred = recipe.ingredients.slice();
...
const removeLastCharacters = (str, numberOfCharacters) => {
  ...
  if(numberOfCharacters > str.length){
    ...
    const sliceNumber = str.length - numberOfCharacters;
